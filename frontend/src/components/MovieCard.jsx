...
export default function MovieCard({ item }) {
  return (
    <div className="group flex flex-none flex-col snap-start w-38 shrink-0 transition-all duration-300 hover:scale-105">
      <img
      ...
      <h4 className="text-sm font-bold line-clamp-2">{item.title? item.title: item.name}</h4>
